...
const yourID = "272004278082600960"; //Instructions on how to get this: https://redd.it/40zgse
...
const roles = ["PUBG", "FORTNITE", "APEX", "GTA-V"];
const reactions = ["💻", "🖌", "😃", "🆕"];
const embed = true; // Set to "true" if you want all roles to be in a single embed
const embedColor = "#dd2423"; // Set the embed color if the "embed" variable is set to true
const botToken = "NTU3NTY4NDMwMjgzMjkyNjcz.D3KLnA.qSZoIp42RXqPqqEU8q11B3_Zj3U";
/**
